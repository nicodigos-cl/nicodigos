...
export default async function CheckoutReturnPage({
  ...
  return (
    <main className="flex flex-1 items-center justify-center px-4 py-16 relative overflow-hidden bg-background min-h-[calc(100vh-4rem)]">
      ...
      <div
        className={cn(
          "absolute inset-0 -z-10 blur-[150px] opacity-40 pointer-events-none rounded-full w-[600px] h-[600px] mx-auto my-auto",
          currentStatus.bgOrb,
        )}
      />
        ...
        <CardFooter className="px-6 pb-8 pt-2 flex flex-col gap-3 sm:flex-row sm:justify-center">
          {result.outcome === "paid" || result.outcome === "pending" ? (
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto font-bold shadow-md hover:scale-[1.01] active:scale-[0.99] transition-transform"
            >
          ...
          <Button
            ...
            asChild
            size="lg"
            className="w-full sm:w-auto font-semibold hover:bg-muted/50"
          >
