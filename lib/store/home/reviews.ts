...
export const homeReviews: HomeReview[] = [
  {
    ...
    rating: 5,
    title: "Key al tiro",
    body: "Compré un juego de Steam y la key llegó en minutos. Todo clarito en mis pedidos.",
    platform: "Steam",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    rating: 4,
    title: "Buen soporte",
    body: "Tuve una duda con la región del juego y me respondieron rápido por correo. Se pasaron.",
